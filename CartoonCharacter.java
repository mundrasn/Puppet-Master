...
public class CartoonCharacter {
    ...
    public double getHeight(){
        return this.characterHeight = 100;
    }
    ...
    private void drawElmo(){
        String fname = "img\\elmo.jpg";
        UI.drawImage(fname, this.characterX, this.characterY, 120, 120);
        UI.sleep(500);
    }
    
    private void drawRick(){
        String fname = "img\\Rick-Astley.png";
        UI.drawImage(fname, this.characterX, this.characterY, 130, 130);
        UI.sleep(500);
    }
    
    private void drawConfused(){
        String fname = "img\\confused.png   ";
        UI.drawImage(fname, this.characterX, this.characterY, 110, 110);
        UI.sleep(500);
    }
}
